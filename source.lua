...
-- dsc.gg/thienthanhofficial
-- youtube.com/@thienthanhsamp_official
-- script lỏ thông cảm đi mấy bro=))
local redzlib = loadstring(game:HttpGet("https://raw.githubusercontent.com/thiwnthah/bloxfruit/refs/heads/main/GUI.lua"))()
-- THIWN THAH HUB V2 --
...
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://88562990432140", BackgroundTransparency = 0 },
    Corner = { CornerRadius = UDim.new(0, 5) },
})

-- TAB | V2
local Tab1 = Window:MakeTab({"DISCORD"})
local Tab2 = Window:MakeTab({"HOME"})
local Tab3 = Window:MakeTab({"ITEMS"})
local Tab4 = Window:MakeTab({"FRUIT"})
local Tab5 = Window:MakeTab({"STATS"})
local Tab6 = Window:MakeTab({"TELEPORT"})
local Tab7 = Window:MakeTab({"USER"})
local Tab8 = Window:MakeTab({"SHOP"})
local Tab9 = Window:MakeTab({"SETTING"})
