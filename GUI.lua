	...
	Themes = {
		THIWNTHAHHUB = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(250, 250, 250)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(250, 250, 250)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(250, 250, 250))
			}),
			["Color Hub 2"] = Color3.fromRGB(200, 200, 200),
			["Color Stroke"] = Color3.fromRGB(200, 200, 200),
			["Color Theme"] = Color3.fromRGB(250, 250, 250),
